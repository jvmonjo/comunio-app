...
values
  ...
  ('Rellotge', 'Un detall especial per al dia de la comunio.', 120, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=400&q=80', '[{"store_name": "Rellotgeria local", "price": 120}]'::jsonb),
