...
insert into public.gifts (name, description, price, image_url, purchase_options, is_visible)
values ('Regal Ocult', 'Aquest regal no s''hauria de veure a la web pública.', 10, null, '[]'::jsonb, false);
